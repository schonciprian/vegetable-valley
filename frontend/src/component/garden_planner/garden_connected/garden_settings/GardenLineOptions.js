...
export function GardenLineOptionsColumn(props) {
    ...
    return (
        <div className="options options-column" data-column={index}>
            ...
            {props.dustbinNeeded && gardenSize.columns > 1 ? <AiFillDelete onClick={() => editColumnInGarden(index, 'remove')}/> : ""}
        </div>
    );
}
...
export function GardenLineOptionsRow(props) {
    ...
    return (
        <div className="options options-row" data-row={index}>
            ...
            {props.dustbinNeeded && gardenSize.rows > 1 ? <AiFillDelete onClick={() => editRowInGarden(index, 'remove')}/> : ""}
        </div>
    );
}
