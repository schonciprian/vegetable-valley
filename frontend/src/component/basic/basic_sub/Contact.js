...
// Stylesheets
import '../../../stylesheet/basic/basic_sub/Contact.css';
        ...
        <div className="contact">
            <div className="personal-information">
                ...
                <p>
                    ...
                    <span>Name:</span>&nbsp;
                    <span className="contact-value">Ciprián Schőn</span>
                </p>
                <p>
                    <GrMail className="contact-icon"/>&nbsp;
                    <span>Email:</span>&nbsp;
                    <a className="contact-value" href = "mailto: schon.ciprian@gmail.com" target="blank">
                        schon.ciprian@gmail.com</a>
                </p>
                <p>
                    <FaGithub className="contact-icon"/>&nbsp;
                    <a href="https://github.com/schonciprian/vegetable-valley" target="blank">Code on GitHub</a>
                </p>
                <p>
